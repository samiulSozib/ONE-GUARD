...
interface DutyTimeTypeCreateDialogProps {
    trigger: ReactNode
    isOpen?: boolean
    onOpenChange?: (open: boolean) => void
}

export function DutyTimeTypeCreateForm({ trigger, isOpen, onOpenChange }: DutyTimeTypeCreateDialogProps) {
        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="sm:max-w-[800px] w-[80vw] max-w-[80vw] mx-auto max-h-[80vh] overflow-y-auto dark:bg-gray-900 p-4 sm:p-6">
                ...
                <div className="flex items-center gap-2 text-lg font-semibold mb-4 sm:mb-6">
                    ...
                    <span className="whitespace-nowrap">Add New Type</span>
                </div>
