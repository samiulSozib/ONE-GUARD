...
import { DutyTimeTypeCreateForm } from './duty-time-type-create-form'

const DutyTimeTypeTopCard = () => {
    return (
        <Card className='flex flex-col gap-4 md:flex-row md:items-center md:justify-between p-2 lg:p-4'>
            {/* Button Group Section */}
            <div className='flex flex-row gap-3'>
                <span className='text-lg font-bold dark:text-white'>Duty Time Type</span>
...
export default DutyTimeTypeTopCard