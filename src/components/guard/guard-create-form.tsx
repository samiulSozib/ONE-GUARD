...
export function GuardCreateForm({ 
    ...
    const onSubmit = async (data: GuardFormData) => {
        ...
        try {
            ...
            // Use the auto-generated code if guard_code is empty
            const finalGuardCode = data.guard_code || autoGeneratedCode
            ...
            Object.entries(data).forEach(([key, value]) => {
                if (value !== undefined && value !== null) {
                    ...
                    } else if (key === 'document_types') {
                        // Stringify document_types array
                        formData.append(key, JSON.stringify(value || []))
