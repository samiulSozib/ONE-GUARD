// components/client-contract-service/client-contract-service-create-form.tsx
"use client";
...
interface ClientContractServiceCreateFormProps {
  trigger: ReactNode;
  isOpen?: boolean;
...
export function ClientContractServiceCreateForm({
  ...
  const onSubmit = async (data: ContractServiceFormData) => {
    ...
    try {
      ...
      const result = await dispatch(createClientContractService(submitData));

      if (createClientContractService.fulfilled.match(result)) {
    ...
    <Dialog open={isOpen} onOpenChange={handleDialogOpenChange}>
      ...
      <DialogContent className="sm:max-w-[800px] w-[95vw] max-w-[95vw] mx-auto max-h-[90vh] overflow-y-auto dark:bg-gray-900 p-6">
        ...
        <div className="flex items-center gap-2 text-lg font-semibold mb-6 pb-2 border-b">
          ...
          <span className="whitespace-nowrap">Add Contract Service</span>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <DialogActionFooter
            cancelText="Cancel"
            submitText="Create Contract Service"
