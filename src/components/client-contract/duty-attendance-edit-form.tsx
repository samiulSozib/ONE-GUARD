...
// import { updateAttendance, fetchAttendance } from "@/store/slices/dutyAttendenceSlice"
// import { fetchGuards } from "@/store/slices/guardSlice"
// import { fetchDuties } from "@/store/slices/dutySlice"
// import { UpdateDutyAttendanceDto } from "@/app/types/dutyAttendance"
...
// interface DutyAttendanceEditFormProps {
//     trigger: ReactNode
//     attendanceId: number
//     isOpen?: boolean
...
// export function DutyAttendanceEditForm({
//     trigger,
//     attendanceId,
//     isOpen,
//     onOpenChange,
//     onSuccess
// }: DutyAttendanceEditFormProps) {
...
//     const { currentAttendence, isLoading: attendanceLoading } = useAppSelector((state) => state.dutyAttendance)
...
//     // Fetch attendance details when dialog opens
//     useEffect(() => {
...
//         setIsFetching(true)
//         try {
//             const result = await dispatch(fetchAttendance({id:attendanceId}))

//             if (fetchAttendance.fulfilled.match(result)) {
//                 const data = result.payload.item

//                 // Parse dates and times
//                 const checkInDatetime = parseISO(data.check_in_time)
//                 const checkOutDatetime = parseISO(data.check_out_time)
...
//                 // Check if location exists and set toggle accordingly
//                 const hasLocation = data.latitude && data.longitude
//                 setUseCurrentLocation(hasLocation)

//                 // Set search values for dropdowns
//                 if (data.guard) {
//                     setGuardSearch(`${data.guard.full_name} ${data.guard.guard_code}`)
//                 }
//                 if (data.duty) {
//                     setDutySearch(data.duty.title)
//                 }

//                 // Populate form with existing data
//                 reset({
//                     guard_id: data.guard_id || undefined,
//                     duty_id: data.duty_id || undefined,
//                     check_in_time: data.check_in_time || "",
//                     check_out_time: data.check_out_time || "",
//                     status: data.status as "present" | "absent" | "late" | "half_day" | "leave" || "present",
...
//             SweetAlertService.error('Error', 'Failed to load attendance details')
//         } finally {
//             setIsFetching(false)
//         }
//     }
...
//     useEffect(() => {
//         if (useCurrentLocation && (!formValues.latitude || !formValues.longitude)) {
//             getCurrentLocation()
//         } else if (!useCurrentLocation && (formValues.latitude || formValues.longitude)) {
...
//             const submitData: UpdateDutyAttendanceDto = {
...
//             console.log('Updating attendance:', submitData)

//             const result = await dispatch(updateAttendance({
//                 id: attendanceId,
//                 data: submitData
//             }))
...
//             onOpenChange?.(true)
//         } else {
//             // Check if form has been modified by comparing with original data
//             const originalData = selectedAttendance ? {
//                 guard_id: selectedAttendance.guard_id,
//                 duty_id: selectedAttendance.duty_id,
...
//                 currentData.check_in_time !== originalData.check_in_time ||
//                 currentData.check_out_time !== originalData.check_out_time ||
...
//                 currentData.remarks !== originalData.remarks
...
//                     <span className="whitespace-nowrap">Edit Duty Attendance</span>
//                 </div>
