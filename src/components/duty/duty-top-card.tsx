...
import { DutyCreateForm } from './duty-create-form'

const DutyTopCard = () => {
    return (
        <Card className='flex flex-col gap-4 md:flex-row md:items-center md:justify-between p-2 lg:p-4'>
            {/* Button Group Section */}
            <span className='text-lg font-bold dark:text-white'>Duty List</span>
