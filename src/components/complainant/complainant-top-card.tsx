...
import { ComplainantCreateForm } from './complainant-create-form'

const ComplainantTopCard = () => {
    return (
        <Card className='flex flex-col gap-4 md:flex-row md:items-center md:justify-between p-2 lg:p-4'>
            {/* Button Group Section */}
            <span className='text-lg font-bold dark:text-white'>Complainant List</span>
            {/* Action Buttons Section */}
            <div className='flex flex-row gap-2 w-full md:w-auto'>
                
                <ComplainantCreateForm
                    trigger={
                        <Button
                        ...
                        >
                            ...
                            <span className="">Add Complainant</span>
                        </Button>
                   } />
...
export default ComplainantTopCard