// components/job-category/job-category-top-card.tsx
"use client";
...
const JobCategoryTopCard = () => {
    return (
        <Card className='flex flex-col gap-4 md:flex-row md:items-center md:justify-between p-2 lg:p-4'>
            <span className='text-lg font-bold dark:text-white'>Job Categories</span>
...
export default JobCategoryTopCard;