...
import { CalendarIcon, DollarSign, Tag, Building, Users, Search, Receipt, Plus } from "lucide-react"
import { useAppDispatch } from "@/hooks/useAppDispatch"
import { useAppSelector } from "@/hooks/useAppSelector"
import { createExpenseReview } from "@/store/slices/expenseReviewSlice"
...
import { ExpenseCreateForm } from "../expense/expense-create-form"
...
export function ExpenseReviewCreateForm({
    ...
    const [expenseCreateDialogOpen, setExpenseCreateDialogOpen] = useState(false)

    // Redux states for dropdown data
    const { expenses, isLoading: expensesLoading } =
    ...
    }, [expenseSearch, dispatch, isOpen])

    // Handle expense creation success
    ...
    // Custom render for Expense dropdown with plus icon
    const renderExpenseDropdown = () => (
        <div className="space-y-2">
            ...
            <div className="flex gap-2">
                ...
                <Button
                    ...
                    onClick={() => setExpenseCreateDialogOpen(true)}
                    disabled={isLoading}
    ...
    return (
        <>
            <Dialog open={isOpen} onOpenChange={handleDialogOpenChange}>
                ...
                <DialogContent className="sm:max-w-[700px] w-[90vw] max-w-[90vw] mx-auto max-h-[85vh] overflow-y-auto dark:bg-gray-900 p-6">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        {/* Expense Selection with Plus Button */}
                        <div className="space-y-2">
            ...
            <ExpenseCreateForm
                trigger={<div />}
                isOpen={expenseCreateDialogOpen}
                onOpenChange={setExpenseCreateDialogOpen}
